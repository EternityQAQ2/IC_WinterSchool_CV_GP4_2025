...
class CNN(nn.Module):
    def __init__(self, in_channels, num_classes=10):
        ...
        # First convolutional layer: 1 input channel, 16 output channels, 5x5 kernel, stride 1, padding 1
        self.conv1 = nn.Conv2d(in_channels=in_channels, out_channels=16, kernel_size=5, stride=1, padding=1)
